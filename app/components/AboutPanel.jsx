          ...
          <div className="border-t border-slate-800 pt-6">
            ...
            <div className="space-y-3">
              {[
                ...
                { name: 'Game Theory Simulator', tag: 'Toolkit', tagColor: { bg: '#0d948818', color: '#2dd4bf', border: '#0d948825' }, desc: 'Interactive simulation environment for game-theoretic thinking. Twelve scenarios across cooperation, bargaining, competition, and signaling domains. Users make real decisions against AI opponents, receive payoff matrix analysis, and build strategic intuition through structured debrief.' },
