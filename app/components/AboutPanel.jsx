        ...
        <div className="space-y-7 fade-in">
          ...
          <div className="border-t border-slate-800 pt-6">
            ...
            <div className="space-y-3">
              {[
                { name: 'STEEP Analysis', tag: 'Toolkit', tagColor: { bg: '#2563eb18', color: '#60a5fa', border: '#2563eb25' }, desc: 'Six-agent AI framework analysing any subject across Social, Technological, Economic, Environmental, and Political dimensions. Produces a 3D force map, forecast roadmap, geoeconomic Big Cycle assessment, and — for public companies — an AI-generated investment thesis.' },
                { name: 'RASCEF Generator', tag: 'Toolkit', tagColor: { bg: '#7c3aed18', color: '#a78bfa', border: '#7c3aed25' }, desc: 'A six-element prompt architecture — Role, Action, Situation, Context, Expectation, Format — that produces precise, deployable AI instructions for any analytical context.' },
