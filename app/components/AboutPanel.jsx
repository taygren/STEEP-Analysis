          ...
          <div className="border-t border-slate-800 pt-6">
            ...
            <div className="space-y-3">
              {[
                ...
                { name: 'Game Theory Simulator', tag: 'Toolkit', tagColor: { bg: '#7c3aed18', color: '#c084fc', border: '#7c3aed25' }, desc: 'Interactive simulation environment for game-theoretic thinking. Eighteen scenarios across cooperation, bargaining, competition, signaling, and zero-sum domains. Users make real decisions against AI opponents, receive payoff matrix analysis, and build strategic intuition through structured debrief.' },
